module PageHistoryHelper
  ...
  def build_description(page_history)
    ...
    when PageHistory::GrantGroupFullAccess   then I18n.t(:page_history_granted_group_full_access, :user_name => user_name, :object_name => page_history.object.full_name)
    when PageHistory::GrantGroupWriteAccess  then I18n.t(:page_history_granted_group_write_access, :user_name => user_name, :object_name => page_history.object.full_name)
    when PageHistory::GrantGroupReadAccess   then I18n.t(:page_history_granted_group_read_access, :user_name => user_name, :object_name => page_history.object.full_name)
    when PageHistory::RevokedGroupAccess     then I18n.t(:page_history_revoked_group_access, :user_name => user_name, :object_name => page_history.object.full_name)
    when PageHistory::GrantUserFullAccess    then I18n.t(:page_history_granted_user_full_access, :user_name => user_name, :object_name => page_history.object.display_name)
    when PageHistory::GrantUserWriteAccess   then I18n.t(:page_history_granted_user_write_access, :user_name => user_name, :object_name => page_history.object.display_name)
    when PageHistory::GrantUserReadAccess    then I18n.t(:page_history_granted_user_read_access, :user_name => user_name, :object_name => page_history.object.display_name)
    when PageHistory::RevokedUserAccess      then I18n.t(:page_history_revoked_user_access, :user_name => user_name, :object_name => page_history.object.display_name)
