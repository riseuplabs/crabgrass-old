...
#      :complete => show(checkbox_id) + remove_class_name(li_id, 'spinner_icon')
  ...
  ## COLLECTIONS HELPERS
  # Generate a select with all Collections a user can add Pages to
  # The Collections are chosen based n the type of the Page
  # and if the user is creating/editing a Page inside a Group or not.
