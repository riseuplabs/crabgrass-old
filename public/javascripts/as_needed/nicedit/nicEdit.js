...
var nicEditor = bkClass.extend({
	...
	panelInstance : function(e,o) {
		...
		var panelElm = new bkElement('DIV').setStyle({width : (e.getStyle('width') || e.clientWidth)+'px'}).appendBefore(e);
...
var nicEditorFontFormatSelect = nicEditorSelect.extend({
    ...
    /* removed H6, H5 from font-formating */
		sel : {'p' : 'Paragraph', 'pre' : 'Pre', 'h4' : 'Heading&nbsp;4', 'h3' : 'Heading&nbsp;3', 'h2' : 'Heading&nbsp;2', 'h1' : 'Heading&nbsp;1'},
...
/* END CONFIG */
/*
this is disabled, because we define our own image button.
