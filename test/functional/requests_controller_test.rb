...
class RequestsControllerTest < ActionController::TestCase
  fixtures :users, :memberships, :groups, :profiles, :languages, :requests
#, :federatings
#, :sites, :requests

  def test_reject_requires_post
    login_as :yellow
    request = RequestToJoinUs.last :conditions => {:recipient_id => users(:yellow)}
  ...
  def test_approve_requires_post
    login_as :purple
    request = RequestToJoinUs.last :conditions => {:recipient_id => users(:purple)}
  ...
  def test_destroy_requires_post
    login_as :gerrard
    request = RequestToJoinUs.last :conditions => {:recipient_id => users(:orange)}
